...
#elif CONFIG_CONS_INDEX == 4 && defined(CONFIG_SUN5I)
	sunxi_gpio_set_cfgpin(SUNXI_GPC(16), SUN5I_GPC16_UART3_TX);
	sunxi_gpio_set_cfgpin(SUNXI_GPC(17), SUN5I_GPC17_UART3_RX);
	sunxi_gpio_set_pull(SUNXI_GPC(17), 1);
